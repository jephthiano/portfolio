...
const skill = [
    ...
    {"id":"6","s_type":"frontend dev","s_skill":"React JS","s_level":"Expert"},
    {"id":"7","s_type":"frontend dev","s_skill":"Alpine JS","s_level":"Expert"},
    {"id":"8","s_type":"frontend dev","s_skill":"JQuery","s_level":"Expert"},

    {"id":"11","s_type":"backend dev","s_skill":"PHP","s_level":"Expert"},
    {"id":"12","s_type":"backend dev","s_skill":"Laravel","s_level":"Experienced"},
    {"id":"13","s_type":"backend dev","s_skill":"Node JS","s_level":"Expert"},
    {"id":"14","s_type":"backend dev","s_skill":"Express JS","s_level":"Expert"},
    
    {"id":"21","s_type":"database","s_skill":"SQL","s_level":"Expert"},
    {"id":"22","s_type":"database","s_skill":"MySQL","s_level":"Expert"},
    {"id":"23","s_type":"database","s_skill":"MongoDB","s_level":"Expert"},
    {"id":"24","s_type":"database","s_skill":"Redis","s_level":"Expert"},
    {"id":"25","s_type":"database","s_skill":"PostgreSQL","s_level":"Experienced"},

    {"id":"31","s_type":"others","s_skill":"TypeScript","s_level":"Expert"},
    {"id":"32","s_type":"others","s_skill":"Docker","s_level":"Expert"},
    {"id":"33","s_type":"others","s_skill":"Kubernetes","s_level":"Expert"},
    {"id":"34","s_type":"others","s_skill":"WebSocket","s_level":"Expert"},
    {"id":"35","s_type":"others","s_skill":"Git","s_level":"Expert"},
]
...
const project = [
    ...
    {"id":"5","p_type":"web","p_name":"Logistics Landing Page","p_link":"https://smartmovelogis.000webhostapp.com","p_rank":3,"p_color":"black","p_languages":"HTML, CSS, JavaScript, Jquery, PHP, AJAX, JSON and XML","p_info":"A 6 pages websites which focus on Logistics.\r\nIt features include:\r\n- Landing Page\r\n- Whatsapp Connect and Call Buttons\r\n- Contact Us, FAQ, Policy Privacy and co Pages\r\n- Social Handles Connects\r\n- Social Handles Connects\r\n- Many more features","projectImg":"smartmovelog.jpg"},
    {"id":"6","p_type":"web","p_name":"Real Estate Website","p_link":"https://jephrealestate.000webhostapp.com","p_rank":3,"p_color":"black","p_languages":"HTML, CSS, JavaScript, Jquery, PHP, MySql, AJAX, JSON and XML","p_info":"This project approaches the problem of finding a real estate property within a locality through a certain real estate management firm.\r\nIt features include:\r\n- Admin section with different admin level\r\n- Uploading new, editing and deleting property at the admin section\r\n- Browsing new property by user\r\n- Users can make appointment on property that entice them\r\n- Blog section\r\n- Comment can be added on blog\r\n- Articles can be shared on other platform with just a click\r\n- Many more features","projectImg":"realestate.jpg"},
